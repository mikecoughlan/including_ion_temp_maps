...
python3 twins_model_v_maxpooling.py --target 'dbht_max' --cluster 'non_cluster_regions' --region 'ALSK'
python3 twins_model_v_maxpooling.py --target 'dbht_max' --cluster 'non_cluster_regions' --region 'HUD-0'
python3 twins_model_v_maxpooling.py --target 'dbht_max' --cluster 'non_cluster_regions' --region 'HUD-1'
